        ...
        <div class="w-full h-full backdrop-blur-md bg-black/20 flex justify-center items-center">
            <div class="w-[70%] h-[67.5%] bg-black/50 flex justify-center align-middle rounded-xl ">
                ...
                <div class="w-[100%] h-[100%] md:w-[40%] md:h-[full] md:bg-slate-500/50 flex-col justify-center align-middle rounded-md ">
                    ...
                    <div class="p-5">
                        <form action="/NotesMain" class="w-[100%] h-[75%]  mt-3">
                            ...
                            <input type="checkbox" name="check" id="" class=""><span class="text-base font-normal text-white ml-1 -mt-1">Remember me</span>        
                            <input type="submit" class="rounded-md w-full h-10  bg-slate-800 font-bold hover:bg-gray-950 focus:bg-slate-800 hover:scale-105 transition-all duration-100 text-white mt-10" value="Login">
        
                            <div class="w-\[100\%\]  flex justify-center gap-2 -mt-4">
                                <input type="submit" class="rounded-md w-full h-10 mt-7 bg-slate-800 font-bold text-white hover:bg-gray-950 focus:bg-slate-800 hover:scale-105 transition-all duration-100" value="Forgot password">
                                <input type="button" class="rounded-md w-full h-10 mt-7 bg-slate-800 font-bold text-white hover:bg-gray-950 focus:bg-slate-800 hover:scale-105 transition-all duration-100" value="Register">
                            </div>                  
                        </form>
                    </div>
                </div>
